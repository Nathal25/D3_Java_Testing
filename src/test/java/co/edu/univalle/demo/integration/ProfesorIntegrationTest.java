...
class ProfesorIntegrationTest extends BaseIntegrationTest {
    ...
    private int port;
    // Metodo helper que construye la URL base del endpoint de profesores
    // incluye el context-path /demo-ds-univalle y la versión /api/v1
    private String baseUrl() {
        return "http://localhost:" + port + "/demo-dsunivalle/api/v1/profesores";
    }
    ...
    // Metodo helper que construye un ProfesorModel de prueba sin id
    ...
    // ── Obtener todos
    @Test
    @DisplayName("GET /api/v1/profesores - retorna lista de profesores con HTTP200")
    ...
    // ── Actualizar
    @Test
    @DisplayName("PUT /api/v1/profesores - actualiza profesor y retorna HTTP200")
