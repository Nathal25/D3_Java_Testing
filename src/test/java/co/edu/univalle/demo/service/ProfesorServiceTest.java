...
// Importamos el model (entidad JPA) y el repository que vamos a simular conMockito
...
// @ExtendWith conecta JUnit 5 con Spring para que Mockito funcionecorrectamente
...
class ProfesorServiceTest {
    ...
    void
    whenCreateProfesor_withDuplicateIdentificacion_thenThrowBusinessException() {
        var profesor = buildProfesor();
    ...
    void
    whenUpdateProfesor_withNonExistingId_thenThrowResourceNotFoundException() {
        var profesor = buildProfesor();
    ...
    void
    whenDeleteProfesor_withNonExistingId_thenThrowResourceNotFoundException() {
    ...
    void
    whenGetProfesorById_withNonExistingId_thenThrowResourceNotFoundException() {
        given(profesorRepository.findById(99L))
                .willReturn(Optional.empty());
        assertThrows(ResourceNotFoundException.class,
